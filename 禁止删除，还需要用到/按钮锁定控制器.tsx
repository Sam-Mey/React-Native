...
const App = () => {
    ...
    // 自定义起始时间和结束时间
    const startTime = moment().tz('Asia/Shanghai').startOf('day').hour(14).minute(0); // 当天15:10
    const endTime = moment().tz('Asia/Shanghai').startOf('day').hour(15).minute(30); // 当天15:11
    ...
    useEffect(() => {
        const calculateRemainingTime = () => {
            ...
            if (currentTime.isBefore(startTime)) {
                ...
                setIsDisabled(false);
                const nextStartTime = currentTime.clone().add(1, 'day').startOf('day').hour(15).minute(0);
